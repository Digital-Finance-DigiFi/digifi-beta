...
from src.digifi.probability_distributions.general import ProbabilityDistributionInterface
...
class PortfolioInstrumentStruct(DataClassValidation):
    ...
    def get_price(self, t: int, data_format: PortfolioInstrumentResultType=PortfolioInstrumentResultType.ARRAY) -> float:
        """
        ## Description
        ...
        ### Input:
            - t: Time index beyond which no data will be returned
            - data_format: Format of the returned datd (i.e., return an array of the historical data of a float value)
        ### Output:
    ...
    def get_predictable_income(self, t: int, data_format: PortfolioInstrumentResultType=PortfolioInstrumentResultType.ARRAY) -> float:
        """
        ## Description
